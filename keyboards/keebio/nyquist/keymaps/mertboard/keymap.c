 ...
 * |------+------+------+------+------+------|          |------+------+------+------+------+------|
 * | Vol- | Play | Vol+ |  Alt | GuiBk| Space|          | Space| FnEnt| Alt  | Ins  | Home | End  |
 * `-----------------------------------------'          `-----------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_VOLD, KC_MPLY, KC_VOLU, KC_LALT, KC_GUIBK,KC_SPC,  KC_SPC, KC_FNENT, KC_RALT, KC_INS, KC_HOME, KC_END   \
),
