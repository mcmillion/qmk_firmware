...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
   *   | Prev | Play | Next | LAlt |  LOS |                                       |  L1  | Left | Down |  Up  | Right|
   *   `----------------------------------'                                       `----------------------------------'
   *                                        ,-------------.       ,-------------.
   *                                        | C-Up | F11  |       |C-Left|C-Right|
   *                                 ,------|------|------|       |------+-------+------.
   *                                 |      |      | Hyper|       | RAlt |       |      |
  ...
  [BASE] = LAYOUT_ergodox(
    ...
    KC_LSPO,        KC_Z,        KC_X,        KC_C,        KC_V,        KC_B,        KC_LT,
    KC_MPRV,        KC_MPLY,     KC_MNXT,     KC_LALT,     KC_LGUI,
    LCTL(KC_UP),    KC_F11,
    KC_HYPR,
    ...
    KC_GT,          KC_N,        KC_M,        KC_COMM,     KC_DOT,      KC_SLSH,     KC_RSPC,
  ...
  [MOVE] = LAYOUT_ergodox(
    ...
    KC_VOLD,        KC_MUTE,     KC_VOLU,     KC_NO,       KC_NO,
    KC_NO,          KC_NO,
    KC_NO,
    ...
    KC_NO,          KC_NO,       KC_NO,       KC_NO,       KC_NO,       KC_NO,       KC_NO,
    KC_TRNS,        KC_NO,       KC_NO,       KC_NO,       EPRM,
    KC_NO,          KC_NO,
    KC_NO,
    KC_NO,          KC_NO,       KC_NO
  )
...
const uint16_t PROGMEM fn_actions[] = {
  [1] = ACTION_LAYER_TAP_TOGGLE(MOVE)
};
